...
const transporter = nodemailer.createTransport({
  service:'Gmail',
  auth:{
    user:'torresrosemar23@gmail.com',
    pass:'aedfbuwnvtnweomz'
  }
});
...
db.serialize(() => {
    ...
    db.all(sql,[id],(err,rowsImagenes)=>{
      ...
      res.setHeader('Content-Type', 'text/html; charset=utf-8');
        ...
        res.render('detalles.ejs',{
          ...
          og: {
            title: 'Joyería La Elegancia',
            description: 'Los mejores accesorios en joyas',
            image: 'https://i0.wp.com/blog.retif.es/wp-content/uploads/cuerda.jpg',
  ...
  function registroUsuariosPost(req,res){
   ...
   if(e) return console.error(e.message);
    ...
    const mensaje = {
    from:'torresrosemar23@gmail.com',
    to:email,
    subject:'!Bienvenido a nuestra página web¡',
    text:`Hola ${nombre} , ¡Te damos la Bienvenida a la Joyería La Elegancia, donde ofrecemos producto de calidad que resaltarán tu belleza!`
    }
  ...
  const {nombre_de_usuario,apellido,cedula,telefono,cliente_id,producto_id,cantidad,total_pagado,codigo,ip_cliente,numeroT,cvv,mesV,year,currency,descripcion} = req.body;
      ...
      await axios.post('enviar', paymentData, {
        headers:{
  ...
  db.run(sql,[nombre_de_usuario,apellido,cedula,telefono,cliente_id,producto_id,cantidad,total_pagado,ip_cliente,codigo,numeroT,cvv,mesV,year,currency,descripcion],(err)=>{
    ...
    const mailOptions = {
      from: 'torresrosemar23@gmail.com', // Reemplaza con tu dirección de correo electrónico
      ...
      text: 'Gracias por preferirnos a la hora de comprar telefonos mobiles , su compra ha sido exitosa' // Reemplaza con el contenido del correo electrónico en texto sin formato
    };
