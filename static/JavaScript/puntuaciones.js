...
for (let x = 0; x < estrella.length; x++) {
  ...
  estrella[x].addEventListener('mouseenter', () => {
    ...
    if (estrella[x].src.includes('favorito.png')){
      ...
      for(let i = 0; i <= x; i++) {
        ...
        estrella[i].src = '/img/favorito.png';
     ...
     // const puntuacionElement = producto.querySelector('.puntuacion[data-producto_id="' + productoID + '"]');
      ...
      const data = {
        ...
        fetch('/puntuaciones', {
         ...
         html: '<img src="/img/favorito.png" width="30" alt="Mi imagen">',
         showCloseButton: true,
         showConfirmButton: false
         });

           
          // estrella[4].src='/img/favorito.png';
