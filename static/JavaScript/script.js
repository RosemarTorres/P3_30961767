...
function buscarProductos(){
  ...
  .then(res=>{
   ...
   let url =`/ruta?nombre=${res.producto[0].nombre}&codigo=${res.producto[0].codigo}&precio=${res.producto[0].precio}&descripcion=${res.producto[0].descripcion}&capacidad=${res.producto[0].capacidad}&url=${res.producto[0].url}&origen=${res.producto[0].origen}`;
